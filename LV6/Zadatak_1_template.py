...
print("KNN model: ")
print("Tocnost train: ", format((accuracy_score(y_train, y_train_p))))
print("Tocnost test: ", format((accuracy_score(y_train, y_train_p))))
...
y_train_p = KNN_1.predict(X_train_n)
y_test_p = KNN_1.predict(X_test_n)
...
y_train_p = KNN_100.predict(X_train_n)
y_test_p = KNN_100.predict(X_test_n)
...
print (scores)
scores = cross_val_score(KNN_1, X_train_n, y_train, cv = 10)
print (scores)
scores = cross_val_score(KNN_100, X_train_n, y_train, cv = 10)
print (scores)
